      ...
      alignItems="center">
        ...
        <Grid item>
            <Card flex = {1} >
              ...
              <CardActions>
                  <Button size="small" variant="contained" color="success">良品</Button>
                  <Button size="small" variant="contained" color="secondary">二手</Button>
                  <Button size="small" variant="contained" color="error">不良</Button>
                  <Button size="small" variant="contained">發霉</Button>
                  <Button size="small" variant="outlined">缺貨</Button>
              </CardActions>
            </Card>
        </Grid>
